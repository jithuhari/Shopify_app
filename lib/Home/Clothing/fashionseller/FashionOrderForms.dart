...
class FashionOrderForms extends StatefulWidget {
  @override
  _FashionOrderFormsState createState() => _FashionOrderFormsState();
}

class _FashionOrderFormsState extends State<FashionOrderForms> {
  @override
                                  ...
                                  ListTile(
                                    title:  Row(children: [
                                     Text("Supplier:",style: TextStyle(color: Colors.grey[600],fontSize: 12),),
                                      Text(" Fashion Bazar",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 14),),
