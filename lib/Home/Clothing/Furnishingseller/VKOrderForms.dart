...
class VkOrderForms extends StatefulWidget {
  @override
  _VKOrderFormsState createState() => _VKOrderFormsState();
}

class _VKOrderFormsState extends State<VkOrderForms> {
  @override
                                  ...
                                  ListTile(
                                    title:  Row(children: [
                                     Text("Supplier:",style: TextStyle(color: Colors.grey[600],fontSize: 12),),
                                      Text("V K Traders",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 14),),
