...
class BagOrderForm extends StatefulWidget {
  @override
  _OrderFormsState createState() => _OrderFormsState();
}

class _OrderFormsState extends State<BagOrderForm> {
  @override
                                  ...
                                  ListTile(
                                    title:  Row(children: [
                                     Text("Supplier:",style: TextStyle(color: Colors.grey[600],fontSize: 12),),
                                      Text("Bag Manufacturer",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 14),),
