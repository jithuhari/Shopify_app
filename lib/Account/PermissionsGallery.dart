...
import 'dart:io';
import 'dart:async';
class PermissionsGallery extends StatefulWidget {
  // final String text1;
  // final String text2;
  // PermissionsUdaan(this.text1,this.text2,{Key key});
  @override
  _PermissionsGalleryState createState() => _PermissionsGalleryState();
}

class _PermissionsGalleryState extends State<PermissionsGallery> {
    ...
    return Scaffold(
     ...
     SingleChildScrollView(
          ...
          children: [
              ...
              Padding(
                padding: const EdgeInsets.all(20.0),
                child: Text("Acess photos from your photo gallery"),
              ),
              Padding(
                padding: const EdgeInsets.all(20.0),
                child: RaisedButton(
