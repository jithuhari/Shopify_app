...
class MensBracelet extends StatefulWidget {
  @override
  _MensBraceletState createState() => _MensBraceletState();
}
String text =
...
class _MensBraceletState extends State<MensBracelet> {
  @override
                    ...
                    child: Card(
                      ...
                      child: Padding(
                        ...
                        child: ListTile(
                          ...
                          title: Text("304 Listings"),
                          subtitle: Text("from 19 suppliers"),
                          trailing: Icon(
                            Icons.chevron_right,
                            color: Colors.red,
